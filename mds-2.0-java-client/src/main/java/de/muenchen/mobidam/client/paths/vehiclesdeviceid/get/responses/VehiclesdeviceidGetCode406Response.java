...
public class VehiclesdeviceidGetCode406Response {

    public static class VehiclesdeviceidGetCode406Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesdeviceidGetCode406Response1() {
            super(
                MapUtils.makeMap(
                )
            );

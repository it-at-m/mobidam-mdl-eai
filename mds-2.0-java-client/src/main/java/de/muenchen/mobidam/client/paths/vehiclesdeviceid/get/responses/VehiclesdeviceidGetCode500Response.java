package org.openapijsonschematools.client.paths.vehiclesdeviceid.get.responses;
...
import org.openapijsonschematools.client.paths.vehiclesdeviceid.get.responses.code500response.content.applicationjson.ApplicationjsonSchema2;
...
public class VehiclesdeviceidGetCode500Response {
    ...
    public static class VehiclesdeviceidGetCode500Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public VehiclesdeviceidGetCode500Response1() {
            super(
                Map.ofEntries(

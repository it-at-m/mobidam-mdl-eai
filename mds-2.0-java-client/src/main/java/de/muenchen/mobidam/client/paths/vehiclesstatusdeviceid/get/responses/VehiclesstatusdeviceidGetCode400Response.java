...
public class VehiclesstatusdeviceidGetCode400Response {

    public static class VehiclesstatusdeviceidGetCode400Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesstatusdeviceidGetCode400Response1() {
            super(
                MapUtils.makeMap(
                )
            );

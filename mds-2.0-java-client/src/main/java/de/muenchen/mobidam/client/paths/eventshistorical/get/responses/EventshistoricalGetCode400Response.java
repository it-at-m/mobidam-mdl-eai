...
public class EventshistoricalGetCode400Response {

    public static class EventshistoricalGetCode400Response1 extends ResponseDeserializer<Void, Void, Void> {
        public EventshistoricalGetCode400Response1() {
            super(
                MapUtils.makeMap(
                )
            );

...
public class ReportsfilenameGetCode404Response {

    public static class ReportsfilenameGetCode404Response1 extends ResponseDeserializer<Void, Void, Void> {
        public ReportsfilenameGetCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );

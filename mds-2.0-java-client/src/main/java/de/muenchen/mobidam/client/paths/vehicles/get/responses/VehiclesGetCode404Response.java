...
public class VehiclesGetCode404Response {

    public static class VehiclesGetCode404Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesGetCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );

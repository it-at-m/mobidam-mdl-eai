...
import org.openapijsonschematools.client.paths.eventshistorical.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class EventshistoricalGetCode200Response {
    ...
    public static class EventshistoricalGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public EventshistoricalGetCode200Response1() {
            super(
                Map.ofEntries(

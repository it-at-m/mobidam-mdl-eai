...
import org.openapijsonschematools.client.paths.vehicles.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class VehiclesGetCode200Response {
    ...
    public static class VehiclesGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public VehiclesGetCode200Response1() {
            super(
                Map.ofEntries(

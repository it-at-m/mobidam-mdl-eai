package org.openapijsonschematools.client.paths.stops.get.responses;
...
import org.openapijsonschematools.client.paths.stops.get.responses.code500response.content.applicationjson.ApplicationjsonSchema2;
...
public class StopsGetCode500Response {
    ...
    public static class StopsGetCode500Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public StopsGetCode500Response1() {
            super(
                Map.ofEntries(

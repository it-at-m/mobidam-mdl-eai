package org.openapijsonschematools.client.paths.trips;

import org.checkerframework.checker.nullness.qual.Nullable;
import org.openapijsonschematools.client.RootServerInfo;
import org.openapijsonschematools.client.paths.trips.get.TripsGetQueryParameters;
import org.openapijsonschematools.client.paths.trips.get.Parameters;
import org.openapijsonschematools.client.paths.trips.get.TripsGetResponses;
...
import org.openapijsonschematools.client.paths.Trips;
...
public class TripsGet {
    private static class GetProvider {
        ...
        public static TripsGetResponses.EndpointResponse get(
            GetRequest request,
            ...
            var responsesDeserializer = new TripsGetResponses.TripsGetResponses1();
    ...
    public interface GetOperation {
        ...
        default TripsGetResponses.EndpointResponse get(GetRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
            return GetProvider.get(request, getApiConfiguration(), getSchemaConfiguration(), getClient());
        }
    }

    public interface GettripsendTimeOperation {
        ApiConfiguration getApiConfiguration();
        SchemaConfiguration getSchemaConfiguration();
        HttpClient getClient();
        default TripsGetResponses.EndpointResponse gettripsendTime(GetRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
            return GetProvider.get(request, getApiConfiguration(), getSchemaConfiguration(), getClient());
        }
    }
    ...
    public static class GetRequest {
        public TripsGetQueryParameters.QueryParametersMap queryParameters;
        public RootServerInfo.@Nullable ServerIndex serverIndex;
        public @Nullable Duration timeout;

        public GetRequest(
            TripsGetQueryParameters.QueryParametersMap queryParameters,
    ...
    public static class GetNullableRequest {
        public TripsGetQueryParameters.@Nullable QueryParametersMap queryParameters;
        public RootServerInfo.@Nullable ServerIndex serverIndex;
        public @Nullable Duration timeout;
    }
    ...
    public interface SetterForQueryParameters <T> {
        ...
        default T queryParameters(TripsGetQueryParameters.QueryParametersMap queryParameters) {
            var instance = getInstance();

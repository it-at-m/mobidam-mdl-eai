...
public class StopsGetCode401Response {

    public static class StopsGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public StopsGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );

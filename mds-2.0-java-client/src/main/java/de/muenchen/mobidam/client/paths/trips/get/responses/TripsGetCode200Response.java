...
import org.openapijsonschematools.client.paths.trips.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class TripsGetCode200Response {
    ...
    public static class TripsGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public TripsGetCode200Response1() {
            super(
                Map.ofEntries(

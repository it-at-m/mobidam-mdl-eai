...
import org.openapijsonschematools.client.paths.telemetry.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class TelemetryGetCode200Response {
    ...
    public static class TelemetryGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public TelemetryGetCode200Response1() {
            super(
                Map.ofEntries(

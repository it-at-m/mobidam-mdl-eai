...
public class EventshistoricalGetCode404Response {

    public static class EventshistoricalGetCode404Response1 extends ResponseDeserializer<Void, Void, Void> {
        public EventshistoricalGetCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );

...
public class VehiclesstatusGetCode401Response {

    public static class VehiclesstatusGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesstatusGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );

...
public class TelemetryGetCode400Response {

    public static class TelemetryGetCode400Response1 extends ResponseDeserializer<Void, Void, Void> {
        public TelemetryGetCode400Response1() {
            super(
                MapUtils.makeMap(
                )
            );

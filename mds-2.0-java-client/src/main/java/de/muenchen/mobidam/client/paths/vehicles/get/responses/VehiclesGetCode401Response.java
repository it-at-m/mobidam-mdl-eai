...
public class VehiclesGetCode401Response {

    public static class VehiclesGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );

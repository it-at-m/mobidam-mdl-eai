package org.openapijsonschematools.client.paths.vehicles.get.responses;
...
import org.openapijsonschematools.client.paths.vehicles.get.responses.code500response.content.applicationjson.ApplicationjsonSchema2;
...
public class VehiclesGetCode500Response {
    ...
    public static class VehiclesGetCode500Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public VehiclesGetCode500Response1() {
            super(
                Map.ofEntries(

...
public class TripsGetCode406Response {

    public static class TripsGetCode406Response1 extends ResponseDeserializer<Void, Void, Void> {
        public TripsGetCode406Response1() {
            super(
                MapUtils.makeMap(
                )
            );

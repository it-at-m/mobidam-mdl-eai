...
public class EventshistoricalGetCode202Response {

    public static class EventshistoricalGetCode202Response1 extends ResponseDeserializer<Void, Void, Void> {
        public EventshistoricalGetCode202Response1() {
            super(
                MapUtils.makeMap(
                )
            );

...
public class TripsGetCode401Response {

    public static class TripsGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public TripsGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );

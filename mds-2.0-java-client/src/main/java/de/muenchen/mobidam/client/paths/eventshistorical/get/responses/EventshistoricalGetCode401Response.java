...
public class EventshistoricalGetCode401Response {

    public static class EventshistoricalGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public EventshistoricalGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );

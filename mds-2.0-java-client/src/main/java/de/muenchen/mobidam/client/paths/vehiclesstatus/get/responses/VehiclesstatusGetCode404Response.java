...
public class VehiclesstatusGetCode404Response {

    public static class VehiclesstatusGetCode404Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesstatusGetCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );

...
public class VehiclesdeviceidGetCode400Response {

    public static class VehiclesdeviceidGetCode400Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesdeviceidGetCode400Response1() {
            super(
                MapUtils.makeMap(
                )
            );

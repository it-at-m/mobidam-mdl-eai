...
import org.openapijsonschematools.client.paths.stops.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class StopsGetCode200Response {
    ...
    public static class StopsGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public StopsGetCode200Response1() {
            super(
                Map.ofEntries(

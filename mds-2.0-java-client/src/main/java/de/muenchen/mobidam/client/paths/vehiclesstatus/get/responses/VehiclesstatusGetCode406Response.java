...
public class VehiclesstatusGetCode406Response {

    public static class VehiclesstatusGetCode406Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesstatusGetCode406Response1() {
            super(
                MapUtils.makeMap(
                )
            );

package org.openapijsonschematools.client.paths.eventshistorical.get.responses;
...
import org.openapijsonschematools.client.paths.eventshistorical.get.responses.code500response.content.applicationjson.ApplicationjsonSchema2;
...
public class EventshistoricalGetCode500Response {
    ...
    public static class EventshistoricalGetCode500Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public EventshistoricalGetCode500Response1() {
            super(
                Map.ofEntries(

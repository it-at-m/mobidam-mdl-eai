...
import org.openapijsonschematools.client.paths.eventsrecent.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class EventsrecentGetCode200Response {
    ...
    public static class EventsrecentGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public EventsrecentGetCode200Response1() {
            super(
                Map.ofEntries(

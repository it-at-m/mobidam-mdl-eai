...
public class StopsstopidGetCode401Response {

    public static class StopsstopidGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public StopsstopidGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );

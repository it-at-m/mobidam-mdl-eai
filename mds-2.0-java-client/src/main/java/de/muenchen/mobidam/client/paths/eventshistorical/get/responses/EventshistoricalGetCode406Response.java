...
public class EventshistoricalGetCode406Response {

    public static class EventshistoricalGetCode406Response1 extends ResponseDeserializer<Void, Void, Void> {
        public EventshistoricalGetCode406Response1() {
            super(
                MapUtils.makeMap(
                )
            );

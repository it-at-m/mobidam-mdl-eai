package org.openapijsonschematools.client.paths.trips.get.responses;
...
import org.openapijsonschematools.client.paths.trips.get.responses.code500response.content.applicationjson.ApplicationjsonSchema2;
...
public class TripsGetCode500Response {
    ...
    public static class TripsGetCode500Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public TripsGetCode500Response1() {
            super(
                Map.ofEntries(

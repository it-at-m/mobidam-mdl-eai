package org.openapijsonschematools.client.paths.stopsstopid.get.responses;
...
import org.openapijsonschematools.client.paths.stopsstopid.get.responses.code500response.content.applicationjson.ApplicationjsonSchema2;
...
public class StopsstopidGetCode500Response {
    ...
    public static class StopsstopidGetCode500Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public StopsstopidGetCode500Response1() {
            super(
                Map.ofEntries(

...
public class VehiclesdeviceidGetCode401Response {

    public static class VehiclesdeviceidGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesdeviceidGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );

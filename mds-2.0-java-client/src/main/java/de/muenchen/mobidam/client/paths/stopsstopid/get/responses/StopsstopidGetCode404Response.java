...
public class StopsstopidGetCode404Response {

    public static class StopsstopidGetCode404Response1 extends ResponseDeserializer<Void, Void, Void> {
        public StopsstopidGetCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );

package org.openapijsonschematools.client.paths.eventsrecent.get.responses;
...
import org.openapijsonschematools.client.paths.eventsrecent.get.responses.code500response.content.applicationjson.ApplicationjsonSchema2;
...
public class EventsrecentGetCode500Response {
    ...
    public static class EventsrecentGetCode500Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public EventsrecentGetCode500Response1() {
            super(
                Map.ofEntries(

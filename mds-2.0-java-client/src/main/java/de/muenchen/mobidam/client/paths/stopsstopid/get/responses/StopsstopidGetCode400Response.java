...
public class StopsstopidGetCode400Response {

    public static class StopsstopidGetCode400Response1 extends ResponseDeserializer<Void, Void, Void> {
        public StopsstopidGetCode400Response1() {
            super(
                MapUtils.makeMap(
                )
            );

package org.openapijsonschematools.client.paths.telemetry;

import org.checkerframework.checker.nullness.qual.Nullable;
import org.openapijsonschematools.client.RootServerInfo;
import org.openapijsonschematools.client.paths.telemetry.get.TelemetryGetQueryParameters;
import org.openapijsonschematools.client.paths.telemetry.get.Parameters;
import org.openapijsonschematools.client.paths.telemetry.get.TelemetryGetResponses;
...
import org.openapijsonschematools.client.paths.Telemetry;
...
public class TelemetryGet {
    private static class GetProvider {
        private static final String method = "get";

        public static TelemetryGetResponses.EndpointResponse get(
            GetRequest request,
            ...
            String url = host + Telemetry.path;
            if (queryMap != null) {
            ...
            var responsesDeserializer = new TelemetryGetResponses.TelemetryGetResponses1();
    ...
    public interface GetOperation {
        ...
        default TelemetryGetResponses.EndpointResponse get(GetRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
            return GetProvider.get(request, getApiConfiguration(), getSchemaConfiguration(), getClient());
        }
    }

    public interface GettelemetrytelemetryTimeOperation {
        ApiConfiguration getApiConfiguration();
        SchemaConfiguration getSchemaConfiguration();
        HttpClient getClient();
        default TelemetryGetResponses.EndpointResponse gettelemetrytelemetryTime(GetRequest request) throws IOException, InterruptedException, ValidationException, NotImplementedException, ApiException {
            return GetProvider.get(request, getApiConfiguration(), getSchemaConfiguration(), getClient());
        }
    }
    ...
    public static class GetRequest {
        public TelemetryGetQueryParameters.QueryParametersMap queryParameters;
        public RootServerInfo.@Nullable ServerIndex serverIndex;
        public @Nullable Duration timeout;

        public GetRequest(
            TelemetryGetQueryParameters.QueryParametersMap queryParameters,
    ...
    public static class GetNullableRequest {
        public TelemetryGetQueryParameters.@Nullable QueryParametersMap queryParameters;
        public RootServerInfo.@Nullable ServerIndex serverIndex;
        public @Nullable Duration timeout;
    }
    ...
    public interface SetterForQueryParameters <T> {
        ...
        default T queryParameters(TelemetryGetQueryParameters.QueryParametersMap queryParameters) {
            var instance = getInstance();

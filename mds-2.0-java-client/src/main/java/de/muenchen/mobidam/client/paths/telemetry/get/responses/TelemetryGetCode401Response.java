...
public class TelemetryGetCode401Response {

    public static class TelemetryGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public TelemetryGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );

...
public class EventsrecentGetCode401Response {

    public static class EventsrecentGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public EventsrecentGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );

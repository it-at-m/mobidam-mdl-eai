...
public class TelemetryGetCode406Response {

    public static class TelemetryGetCode406Response1 extends ResponseDeserializer<Void, Void, Void> {
        public TelemetryGetCode406Response1() {
            super(
                MapUtils.makeMap(
                )
            );

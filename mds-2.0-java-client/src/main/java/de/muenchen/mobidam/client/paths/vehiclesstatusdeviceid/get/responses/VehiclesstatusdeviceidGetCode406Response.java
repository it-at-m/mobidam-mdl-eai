...
public class VehiclesstatusdeviceidGetCode406Response {

    public static class VehiclesstatusdeviceidGetCode406Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesstatusdeviceidGetCode406Response1() {
            super(
                MapUtils.makeMap(
                )
            );

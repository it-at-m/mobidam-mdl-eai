...
public class VehiclesdeviceidGetCode404Response {

    public static class VehiclesdeviceidGetCode404Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesdeviceidGetCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );

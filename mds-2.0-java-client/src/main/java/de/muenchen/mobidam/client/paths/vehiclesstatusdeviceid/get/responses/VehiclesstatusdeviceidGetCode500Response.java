package org.openapijsonschematools.client.paths.vehiclesstatusdeviceid.get.responses;
...
import org.openapijsonschematools.client.paths.vehiclesstatusdeviceid.get.responses.code500response.content.applicationjson.ApplicationjsonSchema2;
...
public class VehiclesstatusdeviceidGetCode500Response {
    ...
    public static class VehiclesstatusdeviceidGetCode500Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public VehiclesstatusdeviceidGetCode500Response1() {
            super(
                Map.ofEntries(

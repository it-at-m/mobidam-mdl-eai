...
public class EventsrecentGetCode406Response {

    public static class EventsrecentGetCode406Response1 extends ResponseDeserializer<Void, Void, Void> {
        public EventsrecentGetCode406Response1() {
            super(
                MapUtils.makeMap(
                )
            );

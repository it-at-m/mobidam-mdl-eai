...
public class TripsGetCode404Response {

    public static class TripsGetCode404Response1 extends ResponseDeserializer<Void, Void, Void> {
        public TripsGetCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );

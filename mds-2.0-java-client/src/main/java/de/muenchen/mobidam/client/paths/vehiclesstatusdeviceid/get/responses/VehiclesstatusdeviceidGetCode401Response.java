...
public class VehiclesstatusdeviceidGetCode401Response {

    public static class VehiclesstatusdeviceidGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesstatusdeviceidGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );

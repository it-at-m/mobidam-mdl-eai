...
public class EventsrecentGetCode400Response {

    public static class EventsrecentGetCode400Response1 extends ResponseDeserializer<Void, Void, Void> {
        public EventsrecentGetCode400Response1() {
            super(
                MapUtils.makeMap(
                )
            );

...
public class TripsGetCode202Response {

    public static class TripsGetCode202Response1 extends ResponseDeserializer<Void, Void, Void> {
        public TripsGetCode202Response1() {
            super(
                MapUtils.makeMap(
                )
            );

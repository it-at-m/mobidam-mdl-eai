...
public class VehiclesGetCode406Response {

    public static class VehiclesGetCode406Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesGetCode406Response1() {
            super(
                MapUtils.makeMap(
                )
            );

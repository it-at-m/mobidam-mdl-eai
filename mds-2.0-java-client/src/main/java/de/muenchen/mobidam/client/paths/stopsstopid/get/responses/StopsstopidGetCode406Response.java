...
public class StopsstopidGetCode406Response {

    public static class StopsstopidGetCode406Response1 extends ResponseDeserializer<Void, Void, Void> {
        public StopsstopidGetCode406Response1() {
            super(
                MapUtils.makeMap(
                )
            );

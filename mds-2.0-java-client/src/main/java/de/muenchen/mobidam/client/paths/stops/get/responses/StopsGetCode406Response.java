...
public class StopsGetCode406Response {

    public static class StopsGetCode406Response1 extends ResponseDeserializer<Void, Void, Void> {
        public StopsGetCode406Response1() {
            super(
                MapUtils.makeMap(
                )
            );

...
import org.openapijsonschematools.client.paths.vehiclesdeviceid.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class VehiclesdeviceidGetCode200Response {
    ...
    public static class VehiclesdeviceidGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public VehiclesdeviceidGetCode200Response1() {
            super(
                Map.ofEntries(

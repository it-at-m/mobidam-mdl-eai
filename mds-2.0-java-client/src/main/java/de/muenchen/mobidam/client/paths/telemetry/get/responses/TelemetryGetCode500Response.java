package org.openapijsonschematools.client.paths.telemetry.get.responses;
...
import org.openapijsonschematools.client.paths.telemetry.get.responses.code500response.content.applicationjson.ApplicationjsonSchema2;
...
public class TelemetryGetCode500Response {
    ...
    public static class TelemetryGetCode500Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public TelemetryGetCode500Response1() {
            super(
                Map.ofEntries(

...
public class TripsGetCode400Response {

    public static class TripsGetCode400Response1 extends ResponseDeserializer<Void, Void, Void> {
        public TripsGetCode400Response1() {
            super(
                MapUtils.makeMap(
                )
            );

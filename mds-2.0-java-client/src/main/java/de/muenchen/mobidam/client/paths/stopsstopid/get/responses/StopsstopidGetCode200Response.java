...
import org.openapijsonschematools.client.paths.stopsstopid.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class StopsstopidGetCode200Response {
    ...
    public static class StopsstopidGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public StopsstopidGetCode200Response1() {
            super(
                Map.ofEntries(

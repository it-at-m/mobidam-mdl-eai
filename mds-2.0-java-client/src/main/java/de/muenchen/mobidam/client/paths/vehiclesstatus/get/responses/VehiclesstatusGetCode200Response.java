...
import org.openapijsonschematools.client.paths.vehiclesstatus.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class VehiclesstatusGetCode200Response {
    ...
    public static class VehiclesstatusGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public VehiclesstatusGetCode200Response1() {
            super(
                Map.ofEntries(

...
public class VehiclesstatusdeviceidGetCode404Response {

    public static class VehiclesstatusdeviceidGetCode404Response1 extends ResponseDeserializer<Void, Void, Void> {
        public VehiclesstatusdeviceidGetCode404Response1() {
            super(
                MapUtils.makeMap(
                )
            );

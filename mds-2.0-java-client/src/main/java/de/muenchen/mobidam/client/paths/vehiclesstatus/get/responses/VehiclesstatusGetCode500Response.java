package org.openapijsonschematools.client.paths.vehiclesstatus.get.responses;
...
import org.openapijsonschematools.client.paths.vehiclesstatus.get.responses.code500response.content.applicationjson.ApplicationjsonSchema2;
...
public class VehiclesstatusGetCode500Response {
    ...
    public static class VehiclesstatusGetCode500Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public VehiclesstatusGetCode500Response1() {
            super(
                Map.ofEntries(

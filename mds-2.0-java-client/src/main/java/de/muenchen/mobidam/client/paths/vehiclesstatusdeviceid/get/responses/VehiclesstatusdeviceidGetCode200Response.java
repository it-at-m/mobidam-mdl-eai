...
import org.openapijsonschematools.client.paths.vehiclesstatusdeviceid.get.responses.code200response.content.applicationjson.ApplicationjsonSchema;
...
public class VehiclesstatusdeviceidGetCode200Response {
    ...
    public static class VehiclesstatusdeviceidGetCode200Response1 extends ResponseDeserializer<SealedResponseBody, Void, SealedMediaType> {
        public VehiclesstatusdeviceidGetCode200Response1() {
            super(
                Map.ofEntries(

...
public class ReportsfilenameGetCode401Response {

    public static class ReportsfilenameGetCode401Response1 extends ResponseDeserializer<Void, Void, Void> {
        public ReportsfilenameGetCode401Response1() {
            super(
                MapUtils.makeMap(
                )
            );
